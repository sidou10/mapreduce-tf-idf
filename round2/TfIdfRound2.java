...
public class TfIdfRound2 extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        job.setJobName("TF-IDF Round 2");


        // Precise Driver, Mapper and Reducer
        job.setJarByClass(TfIdfRound2.class);
        job.setMapperClass(TfIdfRound2Mapper.class);
        job.setReducerClass(TfIdfRound2Reducer.class);


        // Types of key/values for the mapper and the reducer
        job.setMapOutputKeyClass(Text.class);
        job.setMapOutputValueClass(WordWordCountWritable.class);
    ...
    public static void main(String[] args) throws Exception {
        TfIdfRound2 exempleDriver = new TfIdfRound2();
